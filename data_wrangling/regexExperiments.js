...
console.log(
  simpleRegA.test("The latest airplane designs evolved from slabcraft."),
); //true
...
console.log(anyDigitMatch.test("in in no digit")); //true
...
console.log(
  "Listov, Barbara Bullock, Sandra".replace(/(\w+), (\w+)/g, "$2 $1"),
); //reverse the pairs
...
let reSentence = /[.:;?!]/g;
let splitSR4 = "this is one sentence. This is a second sentence".split(
  reSentence,
); //-> s's remove
